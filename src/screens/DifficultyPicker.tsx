...
const s=StyleSheet.create({shade:{flex:1,alignItems:'center',justifyContent:'center',padding:16,backgroundColor:'#100b08a8'},panel:{width:'100%',maxWidth:720,padding:16,gap:12,backgroundColor:'#241b12ed',borderColor:'#b99a60',borderWidth:1,borderRadius:8},title:{fontSize:24,color:'#f4dca8',fontWeight:'700',textAlign:'center'},subtitle:{fontSize:12,color:'#c2ad88',textAlign:'center'},options:{flexDirection:'row',flexWrap:'wrap',gap:8},option:{width:'48%',flexGrow:1,padding:12,borderWidth:1,borderColor:'#705a3e',borderRadius:5,backgroundColor:palette.brownSurface,gap:5},selected:{backgroundColor:'#34462e',borderColor:'#e2bf76'},name:{color:'#f0dfbc',fontSize:14,fontWeight:'700'},description:{color:'#c5b89f',fontSize:11},actions:{flexDirection:'row',justifyContent:'center',gap:10},button:{paddingVertical:12,paddingHorizontal:18,borderWidth:1,borderColor:'#a88c56',borderRadius:5}});
