...
/** A reserved Echo remains visible even after its Tide counters are spent. */
export function TideIcon({active, playing, speed}: {active: boolean; playing: boolean; speed: number}) {
  ...
  return <Animated.View style={{width: 18, height: 18, borderRadius: 9,
    backgroundColor: combatColors.echoSurface,
    boxShadow: active ? `0 0 7px ${combatColors.echo}` : 'none',
