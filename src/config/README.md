...
- rules.json defines Health, ten deck slots, five shop slots, 40 ticks, one reshuffle tick, a maximum of two attuned domains and rewards every two rounds.
...
- tournament.json and playback.json control the race to eight wins and replay speeds.
