...
- Each domain's spell.json defines spells and explicit upgrades: 26 in each Domain. Gold equals stars + 1; castTicks is 0 (Instant), 1, 2 or 3. instantDomain/castDomain store conditional cast speed; unattunedCastTicks stores the fallback.
...
All 130 cards are playable at both upgrade levels. Removed systems and old card definitions remain in Git history. See COMBAT_RULES.md for timing, CARDS.md for the current list, and ../../docs/simplification-redesign.md for migration choices.
