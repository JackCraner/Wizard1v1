...
- Affinity at three cards grants +10% direct damage/healing/Ward in that domain; Mastery at five grants +20% instead. These and applicable augment multipliers multiply. Rounded integer amounts are stored in events.
