...
export const rerollCost = (augments: readonly string[], rerolls: number) => augments.includes('scavenger') && rerolls === 0 ? 0 : 1;
export const shopIncome = (augments: readonly string[]) => 10 + (augments.includes('deep-pockets') ? 4 : 0);
